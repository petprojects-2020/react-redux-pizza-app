...
const Bestselling = ({ pizzaItems, onAddToCart }) => {
    if(!pizzaItems){
        return "Загрузка"
    } 
    ...
    return(
        <div className="mt-5 text-center">
            <h2 className="bestselling__heading">BESTSELLING PIZZAS</h2>
            <p className="bestselling__subheading">With a more “contemporary” style, our gourmet pizzas are where
